...
class LanguageModelTrainerEngine(MaximumLikelihoodEstimationEngine):
...
class LanguageModelTrainer():
    ...
    def train(
        ...
        trainer = LanguageModelTrainerEngine(
            LanguageModelTrainerEngine.train,
            model,
            crit,
            optimizer,
            lr_scheduler,
        ...
        evaluator = LanguageModelTrainerEngine(
            LanguageModelTrainerEngine.validate,
            model,
            crit,
            optimizer=None,
            lr_scheduler=None,
        ...
        LanguageModelTrainerEngine.attach(trainer, evaluator, verbose=self.config.verbose)
        ...
        evaluator.add_event_handler(
            Events.EPOCH_COMPLETED, LanguageModelTrainerEngine.check_best
        )
        evaluator.add_event_handler(
            Events.EPOCH_COMPLETED,
            LanguageModelTrainerEngine.save_model,
            trainer,
            self.config,
            src_vocab,
            tgt_vocab
